...
export const UserIcon = (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
    ...
    >
      <path
        d="M12 2C9.24 2 7 4.24 7 7C7 9.76 9.24 12 12 12C14.76 12 17 9.76 17 7C17 4.24 14.76 2 12 2ZM4 20C4 16.13 7.13 13 11 13H13C16.87 13 20 16.13 20 20V21H4V20Z"
        fill="currentColor"
      />
    </svg>
  );  
